...
WebUI.click(findTestObject('Forms/Page_SAFE Home/a_Forms Cloud'))

WebUI.click(findTestObject('Forms/Page_Data Collection, Waivers and Appeals Forms/a_Emergency Medical Waiver'))
...
search = WebUI.getText(findTestObject('Search/Page_Compliance Monitoring/Page_Compliance Monitoring/input_Building IRNName_building'))

WebUI.delay(5)

if (search.contains("$IRN")) {
    println('Result Found') //else {
}
