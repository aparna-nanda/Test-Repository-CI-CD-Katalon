...
WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_Flags'), Flags)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_Flags'), Keys.chord(Keys.ENTER))
