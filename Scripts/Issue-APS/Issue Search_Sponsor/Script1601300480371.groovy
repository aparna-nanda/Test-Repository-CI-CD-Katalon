...
WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_Sponsor_sponsoringOrganization'), CTPD)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_Sponsor_sponsoringOrganization'), Keys.chord(
        Keys.ENTER))
