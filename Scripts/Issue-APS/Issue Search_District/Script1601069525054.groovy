...
WebUI.click(findTestObject('BuildingSearch/Page_Compliance Monitoring/Page_SAFE Home/a_Monitoring'))
...
WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_District_district'), IRN)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_District_district'), Keys.chord(Keys.ENTER))
