...
WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_Audit Date To_auditDateTo'), 01/01/2020)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_Audit Date To_auditDateTo'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_Audit Date From_auditDateFrom'), 10/30/2020)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_Audit Date From_auditDateFrom'), Keys.chord(
        Keys.ENTER))
