...
WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_CTPD_ctpdOrganization'), Sponsor)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_CTPD_ctpdOrganization'), Keys.chord(Keys.ENTER))
