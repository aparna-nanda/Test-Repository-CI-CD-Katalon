...
WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_Issue Name_issueName'), Name)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_Issue Name_issueName'), Keys.chord(Keys.ENTER))
