...
WebUI.setText(findTestObject('Issue Search/Page_Compliance Monitoring/input_Issue Id_issueId'), Id)

WebUI.sendKeys(findTestObject('Issue Search/Page_Compliance Monitoring/input_Issue Id_issueId'), Keys.chord(Keys.ENTER))
